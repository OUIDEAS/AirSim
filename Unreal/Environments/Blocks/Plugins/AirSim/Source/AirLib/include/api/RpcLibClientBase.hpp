...
public:
    ...
    // sensor APIs
	msr::airlib::LidarData doSingleLidarShotFrom(const double horizontal_angle, const double vertical_angle, const std::string& lidar_name = "", const std::string& vehicle_name = "") const;
