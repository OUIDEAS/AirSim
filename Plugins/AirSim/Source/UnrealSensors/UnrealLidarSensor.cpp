    ...
    const msr::airlib::TTimeDelta delta_time, msr::airlib::vector<msr::airlib::real_T>& point_cloud, msr::airlib::vector<int>& segmentation_cloud)
{
    ...
    const float angle_distance_of_tick = 360.0f;
    const float angle_distance_of_laser_measure = angle_distance_of_tick / points_to_scan_with_one_laser;
    ...
    // Log lidar parameters
    UAirBlueprintLib::LogMessageString("Total points to scan : ", std::to_string(total_points_to_scan), LogDebugLevel::Informational);
    UAirBlueprintLib::LogMessageString("Number of lasers : ", std::to_string(number_of_lasers), LogDebugLevel::Informational);
    UAirBlueprintLib::LogMessageString("Points to scan with one laser : ", std::to_string(points_to_scan_with_one_laser), LogDebugLevel::Informational);
    UAirBlueprintLib::LogMessageString("Angle distance of tick: ", std::to_string(angle_distance_of_tick), LogDebugLevel::Informational);
    UAirBlueprintLib::LogMessageString("Angle distance of laser measure: ", std::to_string(angle_distance_of_laser_measure), LogDebugLevel::Informational);
    UAirBlueprintLib::LogMessageString("Laser end: ", std::to_string(laser_end), LogDebugLevel::Informational);
    UAirBlueprintLib::LogMessageString("Laser start: ", std::to_string(laser_start), LogDebugLevel::Informational);
    ...
    // current_horizontal_angle_ = current_horizontal_angle_ + 10;
